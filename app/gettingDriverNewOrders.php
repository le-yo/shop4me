...
if($_SERVER['REQUEST_METHOD']=='POST'){
	...
	//creating a query
	$stmt = $conn->prepare("SELECT * FROM orders WHERE driver_id = 'pending' AND deleted = 'no' AND shipped_status = 'on packaging' AND vehicle_type = '$vehicle_type' ORDER BY id DESC LIMIT 2;");
