...
if($_SERVER['REQUEST_METHOD']=='POST'){
	...
	$strDocumentId = $_POST['strDocumentId'];
	...
	//creating a query
	$stmt = $conn->prepare("SELECT * FROM p_listings WHERE strCounty LIKE '$strCounty%' AND strDocumentId != '$strDocumentId' ORDER BY id DESC;");
